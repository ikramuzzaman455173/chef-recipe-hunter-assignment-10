...
const Login = () => {
  ...
  return (
    <>
      <ChefRecipieBanner title="Login Page" heading="LOGIN Page" />
      <div className='relative top-[17rem] flex flex-col items-center p-2'>
        <div className="w-full mx-auto max-w-md p-4 rounded-md shadow sm:p-8 bg-slate-100 my-10 text-gray-800">
          ...
          <div className="my-6 space-y-4 ">
            ...
            <button onClick={gitHubLogin} aria-label="Log In with GitHub" role="button" className="  active:bg-gray-600 hover:bg-black duration-300 font-semibold focus:none outline-none hover:text-white flex items-center justify-center w-full p-4 space-x-4 border rounded-md focus:ring-2 focus:ring-offset-1 border-gray-600 ">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" className="w-5 h-5 fill-current">
            ...
            {/* <button aria-label="Log In with Twitter" role="button" className=" active:bg-blue-600 hover:bg-blue-400 duration-300 font-semibold focus:none outline-none hover:text-white  flex items-center justify-center w-full p-4 space-x-4 border rounded-md focus:ring-2 focus:ring-offset-1 border-gray-600 ">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" className="w-5 h-5 fill-current">
          ...
          <form className="space-y-8 ng-untouched ng-pristine ng-valid" onSubmit={handleLogin}>
            <div className="space-y-4">
              ...
              <div className="space-y-2 relative">
                <div className="flex justify-between">
                  ...
                  <span className=" focus:underline hover:underline text-blue-500 ml-2 text-sm font-semibold cursor-pointer">Forgot password?</span>
                </div>
            ...
            <button type="submit" className="w-full px-8 py-3 font-semibold rounded-md hover:bg-blue-500 bg-blue-600 text-gray-50">Log In</button>
          </form>
        </div>
      </div>
    </>
